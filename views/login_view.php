...
<head>
	...
	<title>Calendar: User Login Form</title>
	...
	<div class="row">
		...
		<?php $attributes = array("name" => "loginform");
			...
			<div class="form-group">
				...
				<input class="form-control" name="email" placeholder="Enter Email-ID" type="text" id ="emailid" value="<?php echo set_value('email'); ?>" />
				<span class="text-danger"><?php echo form_error('email'); ?></span>
			</div>
			<div class="form-group">
				<label for="passwordid">Password</label>
				<input class="form-control" name="password" placeholder="Password" type="password" id="passwordid" value="<?php echo set_value('password'); ?>" />
